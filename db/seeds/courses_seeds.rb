...
products = Product.create([
  {
    ...
    name: "Let's Talk About Books Class Fee",
    product_type: "fee",
    unit_price: 15,
    courses: Course.where(name: ["Let's Talk About Books"] )
  },{
    ...
    name: "US History Class fee",
    product_type: "fee",
    unit_price: 50,
    courses: Course.where(name: ["US History"] )
  },{
